        ...
        switch (_a.label) {
            case 0:
                ...
                if (!title || typeof title !== "string") {
                    return [2 /*return*/, (0, createError_1.default)("Incorrect title", 400)];
                }
                return [4 /*yield*/, todoService.createTodo({ title: title })];
            case 1:
                _a.sent();
...
var getTodos = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var todos, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var deleteTodo = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var todoId, todo, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                todoId = req.params.todoId;
                return [4 /*yield*/, todoService.getTodoById(todoId)];
            case 1:
                todo = _a.sent();
                if (!todo) {
                    return [2 /*return*/, (0, createError_1.default)("Todo not found", 400)];
                }
                return [4 /*yield*/, todoService.deleteTodo(todoId)];
            case 2:
                _a.sent();
